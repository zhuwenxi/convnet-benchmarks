...
class vgga(chainer.Chain):
    ...
    def __init__(self):
        super(vgga, self).__init__(
            ...
            conv3=L.Convolution2D(128, 256, 3, stride=1, pad=1),
            conv4=L.Convolution2D(256, 256, 3, stride=1, pad=1),
            conv5=L.Convolution2D(256, 512, 3, stride=1, pad=1),
            conv6=L.Convolution2D(512, 512, 3, stride=1, pad=1),
            conv7=L.Convolution2D(512, 512, 3, stride=1, pad=1),
            conv8=L.Convolution2D(512, 512, 3, stride=1, pad=1),
            fc6=L.Linear(512 * 7 * 7, 4096),

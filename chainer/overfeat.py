...
class overfeat(chainer.Chain):
    ...
    def __init__(self):
        super(overfeat, self).__init__(
            ...
            conv2=L.Convolution2D(  96,  256,  5, pad=0),
            conv3=L.Convolution2D( 256,  512,  3, pad=1),
            conv4=L.Convolution2D( 512, 1024,  3, pad=1),
            conv5=L.Convolution2D(1024, 1024,  3, pad=1),
            fc6=L.Linear(1024 * 6 * 6, 3072),
